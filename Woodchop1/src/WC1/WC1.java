...
@ScriptManifest(author = "IWouldNeverBot", info = "Cuts yew trees in Port Sarim.", name = "Yews - Port Sarim", version = 1.0, logo = "")
public class WC1 extends Script {

    // BG Image
    private final Image bg = getImage("http://i.imgur.com/ZYK4rGA.png");
