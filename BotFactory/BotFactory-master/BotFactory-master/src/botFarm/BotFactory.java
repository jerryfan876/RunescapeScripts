...
@ScriptManifest(author = "Auron", info = "A combat account starter, get required stats from tutorial island without having to lift a f" +
		"inger!", logo = "http://i.imgur.com/v8mU8rd.png", name = "Bot Factory", version = 1.0)
